...
| Final artifact, repository, recording, upload, tag, and competition submission | The refreshed eight-entry P0 ZIP reopens and matches its source files; the audited candidate is on public `main` and its latest GitHub Actions CI passed; the real Demo is published through an anonymously verified player; final tag/Release and competition-page submission remain unproven | Human/external incomplete | Tasks 27-30 + Human checkpoint |
